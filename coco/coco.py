...
class COCO:
    ...
    def getAnnIds(self, imgIds=[], catIds=[], areaRng=[], iscrowd=None):
        ...
        :param imgIds  (int array)     : get anns for given imgs
               ...
               areaRng (float array)   : get anns for given area range (e.g. [0
                                         inf])
               iscrowd (boolean)       : get anns for given crowd label (False
                                         or True)
...
#                     sks = np.array(self.loadCats(ann['category_id'])[0][
#                         'skeleton']) - 1
...
#                 print(ann['caption'])
    ...
    def loadRes(self, resFile):
        ...
        if 'caption' in anns[0]:
            ...
            res.dataset['categories'] = copy.deepcopy(self.dataset[
                'categories'])
            raise NotImplementedError('Did not bother installing mask module :)')
#             for id, ann in enumerate(anns):
...
#                 ann['iscrowd'] = 0
    ...
    def download(self, tarDir=None, imgIds=[]):
        ...
        for i, img in enumerate(imgs):
            ...
            print('downloaded %d/%d images (t=%.1fs)' % (i, N,
                                                         time.time() - tic))
